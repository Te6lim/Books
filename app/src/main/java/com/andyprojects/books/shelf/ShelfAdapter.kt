...
class ShelfAdapter: ListAdapter<Book, ShelfAdapter.BookViewHolder>(DiffCallback) {
    ...
    inner class BookViewHolder(private val itemBookBinding: ItemBookBinding): RecyclerView.ViewHolder(itemBookBinding.root) {
        fun bind(book: Book) {
